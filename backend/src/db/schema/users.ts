...
export const users = pgTable(
  'users',
  {
    ...
    subscription_status: varchar('subscription_status', { length: 50 }).default('free'), // 'free' | 'active' | 'trialing' | 'canceled' | 'past_due' | 'expired'
    subscription_plan: varchar('subscription_plan', { length: 50 }).default('free'), // 'free' | 'premium'
    ...
    whop_membership_id: varchar('whop_membership_id', { length: 255 }),
